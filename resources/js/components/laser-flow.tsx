...
export default function LaserFlow({
    ...
    useEffect(() => {
        ...
        const setSizeNow = () => {
            ...
            lastSizeRef.current = { width, height, dpr: pr };
            renderer.setPixelRatio(pr);
            renderer.setSize(width, height, false);
            (uniforms.iResolution.value as THREE.Vector3).set(width * pr, height * pr, pr);
        ...
        const onMove = (event: PointerEvent | MouseEvent) => updateMouse(event.clientX, event.clientY);
